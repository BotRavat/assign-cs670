...
void checkCorrectnessAndUpdate(
    ...
    // vector<int> finalShare0, vector<int> finalShare1, 
    size_t qi)
{
    ...
    cout << "After query procces  User matrix is :\n";
                            ...
                            int n, int k, int modValue)
{
    ...
    for (size_t qi = 0; qi < queries.size(); qi++)
    {
        ...
        cout << "Updated user matrix should be: ";
        cout << "\n";
        ...
        co_spawn(io, [=, &socket_p0]() mutable -> awaitable<void>
                 {
        ...
        co_spawn(io, [=, &socket_p1]() mutable -> awaitable<void>
                 {
                     co_await send_shares_to_party(
                         socket_p1,
                         n, k, modValue,
        ...
        checkCorrectnessAndUpdate(query_i, query_j, modValue,
            //  finalShare0, finalShare1,
              qi);
    }
