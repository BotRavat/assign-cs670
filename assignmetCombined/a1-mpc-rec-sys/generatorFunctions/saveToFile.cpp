...
int main(int argc, char *argv[])
{
    ...
    saveMatrix("/app/matrices/U_matrixFull.txt", U.lVector);
    saveMatrix("/app/matrices/V_matrixFull.txt", V.lVector);
    ...
    saveMatrix("/app/matrices/U_ShareMatrix0.txt", UShares.lvShare0);
    saveMatrix("/app/matrices/U_ShareMatrix1.txt", UShares.lvShare1);
    saveMatrix("/app/matrices/V_ShareMatrix0.txt", VShares.lvShare0);
    saveMatrix("/app/matrices/V_ShareMatrix1.txt", VShares.lvShare1);
